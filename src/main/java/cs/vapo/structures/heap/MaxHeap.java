...
public class MaxHeap {
    ...
    public int pop() {
        ...
        // Percolate down
        while(2 * i < heap.size()) {
            // This essentially just swaps with the right child if the right child is greater than the parent
            if (2 * i + 1 < heap.size() &&
                ...
                heap.set(2 * i + 1, tmp);
                i = 2 * i + 1;
                // This swaps with the left child if it is greater than the parent node
